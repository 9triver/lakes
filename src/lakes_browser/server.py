...
def download_copernicus_product(product: dict, out_dir: Path, progress=None) -> tuple[Path, Path]:
    product_id = clean_optional(product.get("product_id"))
    product_name = clean_optional(product.get("name"))
