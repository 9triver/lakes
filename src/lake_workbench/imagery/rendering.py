"""Lake imagery mosaic metadata, PNG rendering, and XYZ tile rendering."""
...
class ImageryRenderingMixin:
    def image_for_lake(self, lake, size: int = 900, padding: float = 0.3) -> tuple[bytes, dict]:
    ...
    def tile_meta_for_lake(self, lake, padding: float = 0.8) -> dict:
    ...
    def _tci_rows_for_lake(self, lake) -> list[dict]:
        rows = []
